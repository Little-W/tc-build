# Install script for directory: /home/runner/work/tc-build/tc-build/llvm-project/llvm/tools/llvm-ar
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-arx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/runner/work/tc-build/tc-build/build/llvm/stage1/bin/llvm-ar")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-ar" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/home/runner/work/tc-build/tc-build/tc/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-ar")
    endif()
  endif()
endif()
