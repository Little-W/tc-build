# Install script for directory: /home/runner/work/tc-build/tc-build/llvm-project/llvm/tools/llvm-objcopy
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xllvm-objcopyx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/runner/work/tc-build/tc-build/build/llvm/stage1/bin/llvm-objcopy")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-objcopy" AND
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/home/runner/work/tc-build/tc-build/tc/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-objcopy")
    endif()
  endif()
endif()
